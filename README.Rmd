...
[![Codecov test coverage](https://codecov.io/gh/ftsiboe/rexcelbridge/graph/badge.svg)](https://app.codecov.io/gh/ftsiboe/rexcelbridge)
<!-- badges: end -->
...
**Abstract:** `rexcelbridge` provides **vendor-neutral** helpers to execute Excel formulas from R via **COM automation**. It supports single-cell and spilled-array results and includes a pluggable “readiness” predicate to treat transient add-in states (e.g., *“Wait”*, *“Loading…”*) as not yet ready. This enables scripted retrieval of market/pricing and other plugin-delivered data directly into R, while keeping provider logic inside Excel.
...
- **RTD doesn’t update:** Run in a normal **interactive** Windows session (not as a background service).
...
- **Transient “Wait”:** Extend `wait_tokens` in `rb_ready_predicate()` to match provider wording.
